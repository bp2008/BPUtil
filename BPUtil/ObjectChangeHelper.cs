...
namespace BPUtil
{
	...
	{
		/// <summary>
		/// True if [modified] was entirely different from [original], and should simply be applied in whole to whatever object this is applied to.
		/// </summary>
		bool setValue = false;
		Type typeOfMember;
		private object value;
		private Dictionary<string, ObjectChangeHelper> childChanges;

		private bool IsNoOp => !setValue && (childChanges == null || childChanges.Count == 0);
		...
		public ObjectChangeHelper(object original, object modified)
		{
			value = modified;
