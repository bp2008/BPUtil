...
namespace UnitTests
{
	...
	public class TestCSVFile
	{
		...
		[TestMethod]
		public void TestCsvLogicalLineRead()
		{
			string input = "Line1\r\n"
				+ "Line2\r\n"
				+ "Line3,\"Line3\r\nLine3\"Line3\r\n"
			...
			{
				Assert.AreEqual("Line1", CSVFile.ReadLogicalLine(sr));
				Assert.AreEqual("Line2", CSVFile.ReadLogicalLine(sr));
				Assert.AreEqual("Line3,\"Line3\r\nLine3\"Line3", CSVFile.ReadLogicalLine(sr));
				Assert.AreEqual("\"Line4\r\nLine4\"", CSVFile.ReadLogicalLine(sr));
				Assert.AreEqual(null, CSVFile.ReadLogicalLine(sr));
				Assert.AreEqual(null, CSVFile.ReadLogicalLine(sr));
			}
		}
	}
