...
namespace UnitTests
{
	...
	public class TestObjectChangeReplay
	{
		...
		[TestMethod]
		public void TestObjectChangeReplay_SimpleObject_NullNull()
		{
		...
		[TestMethod]
		public void TestObjectChangeReplay_SimpleObject_NullsAllAround()
		{
			ObjectChangeHelper changeHelper = new ObjectChangeHelper(null, null);
			SO obj = null;
			changeHelper.Apply(ref obj);
		...
		[TestMethod]
		public void TestObjectChangeReplay_TypeMismatch()
		{
			try
			{
