...
namespace BPUtil
{
	...
	{
		private static readonly CryptoRandom random = new CryptoRandom(true);
		 ...
		 * Modified in 2018 by bp2008 (https://github.com/bp2008) to make this class private, referenced only from the static SecureRandom class above.
		 * 
		...
		/// </summary>
		[Obsolete("Use RandomNumberGenerator (part of .NET 6.0) instead")]
